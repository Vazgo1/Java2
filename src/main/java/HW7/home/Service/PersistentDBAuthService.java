...
public class PersistentDBAuthService implements AuthenticationService{
    private static final String DB_URL = "jdbc:sqlite:/Users/vazgenvlasan/Desktop/Java2\\users.db";
    ...
    public void start() {
        try {
            ...
            System.err.println("Failed to connect to BD by URL: " + DB_URL);
